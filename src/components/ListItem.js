...
class ListItem extends Component {
    ...
    onClickDeleteItem(){
        this.props.requestDeleteItem(this.props.idItem);
    }

    onClickEditItem(){
        this.props.requestEditItem(this.props.idItem, this.state.name);
...
const mapDispatchToProps = (dispatch, props) => {
    return{
        requestDeleteItem: (id) => {
            dispatch(actions.requestDeleteItem(id));
        },
        requestEditItem: (id, value) => {
            dispatch(actions.requestEditItem(id, value));
        }
    }
};
